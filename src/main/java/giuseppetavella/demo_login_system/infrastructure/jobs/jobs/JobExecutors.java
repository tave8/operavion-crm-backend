...
import giuseppetavella.demo_login_system.infrastructure.jobs.jobs.email_expiring_contracts.EmailExpiringContracts_JobExecutor;
import giuseppetavella.demo_login_system.infrastructure.jobs.job_library.exceptions.JobException;
import giuseppetavella.demo_login_system.infrastructure.jobs.jobs.email_operator_tomorrow_shift.EmailOperatorTomorrowShift_JobExecutor;
import giuseppetavella.demo_login_system.infrastructure.jobs.jobs.notify_admin_because_operator_has_no_shift.NotifyAdminBecauseOperatorHasNoShift_JobExecutor;
import giuseppetavella.demo_login_system.infrastructure.jobs.jobs.send_admin_discrepancies.SendAdminDiscrepancies_JobExecutor;
import giuseppetavella.demo_login_system.infrastructure.jobs.jobs.send_admin_weekly_report.SendAdminWeeklyReport_JobExecutor;
