...
public class ExportShiftsCountByOperatorController {
                                                             ...
                                                             BindingResult validation)
    {
        ...
        return AttachmentResponseBuilder.csv(csv, "report_turni");
     ...
     * Export shifts count by operator as csv
     */
    @PostMapping("/shifts-count-by-operator/pdf")
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    public ResponseEntity<byte[]> exportShiftCountByOperatorPdf(@AuthenticationPrincipal User currentUser,
                                                             @RequestBody @Validated ShiftsCountByOperatorReportParamsSentDTO body,
                                                             BindingResult validation)
    {
        ...
        var pdf = reportGenerator.generatePdf(reportParams);


        return AttachmentResponseBuilder.pdf(pdf, "report_turni");
